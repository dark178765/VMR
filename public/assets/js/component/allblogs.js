...
var allBlogsElement = React.createElement;
...
function allBlogs() {
    ...
    var _React$useState = React.useState({
        ...
        allBlogs = _React$useState2[0],
        setallBlogs = _React$useState2[1];
    ...
    var getBlogs = function getBlogs() {
        ...
        fetch('/all-blogs-josn/' + page + '/' + limit).then(function (res) {
            return res.json();
        }).then(function (res) {
            setallBlogs(res);
        });
    ...
    return React.createElement(
        ...
        React.createElement(
            'div',
            { className: 'row' },
            allBlogs.blogs.length == 0 ? React.createElement('img', { src: '/assets/img/loading.gif', style: { width: '35%', margin: '0 auto' } }) : null,
            allBlogs ? allBlogs.blogs.map(function (ar, index) {
                return React.createElement(
                    'div',
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            'a',
                                            { target: '_blank', href: '/blog/' + ar.slug },
                                            ar.title
                                        )
                                    )
                                ),
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            'a',
                                            { className: 'btn btn-sm btn-secondary', href: '/blog/' + ar.slug },
                                            'Read More'
                                        )
                                    )
                                )
...
var allBlogsContainer = document.querySelector('#allBlogs');
var allBlogsRoot = ReactDOM.createRoot(allBlogsContainer);
