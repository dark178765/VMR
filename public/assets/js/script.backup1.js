...
(function ($) {
    ...
    if ($('.course-count .counterUp').length > 0) {
        ...
        const el = [].slice.call(document.getElementsByClassName('counterUp')); //document.querySelector('.course-count .counterUp, .course-inner-content h4 span, .rate-head span')
